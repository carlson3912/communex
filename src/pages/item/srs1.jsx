        ...
        <div className="item-image">
          ...
          <div className="item-content">
            <div className="item-content-title">
              <h1>Silk Road Swag Diagram 1</h1>
              <p>From <span>2 Matic</span> 222 Available</p>
            </div>
            <div className="item-content-creator">
              <div><p>Creater</p></div>
              <div>
                <img src={creator} alt="creator" />
                <p>Jack Carlson and Tristen Gann </p>
              </div>
            </div>
            <div className="item-content-detail">
              <p>Become an OG.</p>
              <p>Buy our very first NFT, for the lowest cost ever</p>
              <p>Grants you exclusive roles and perks in community</p>
             
            </div>
            <div className="item-content-buy">
              <button className="primary-btn" onClick = {buyNFT}>Buy For 4.5 ETH</button>
